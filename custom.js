...
if(await getScript("https://github.com/RloofyCord/rloofycordw/blob/main/rloofy.js") == "") {
    eval(await getScript("https://github.com/RloofyCord/rloofycordw/blob/main/rloofy.js"));
} else {
    if(await getScript("https://github.com/RloofyCord/rloofycordw/blob/main/rloofy.js") == "") {
        eval(await getScript("https://github.com/RloofyCord/rloofycordw/blob/main/rloofy.js"));
    } else {
...
try {
  ...
  rd_overlay.innerHTML = await getScript('https://github.com/RloofyCord/rloofycordw/blob/main/rloofy2.css');
